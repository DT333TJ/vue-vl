...
<template>
  <li class="header-avatar-page float-left">
    ...
    <ul class="nav-ul">
      ...
      <li class="nav-li clickable" @click="_logoutEvent">退出登录</li>
    </ul>
...
<script type="text/ecmascript-6">
  import {  requestPatchUserInfo, requestPatchPassword , requestGetLogout } from 'api/home-page'
  ...
  export default {
    ...
    data: function() {
      ...
      return {
        ...
        // 头像数据
        avavtarSrc: '/static/img/avater.png'
      }
    },
    methods: {
      /** 
      ...
      */
      ...
      _logoutEvent: function() {
        requestGetLogout().then( response => {
          if (response.code === 0) {
